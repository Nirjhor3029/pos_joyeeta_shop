...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($data['pos']) {
            $data['reference_no'] = 'joy-' . date("Ymd") . '-' . date("his");
...
/*        if ($data['payment_status'] == 3 || $data['payment_status'] == 4 || ($data['payment_status'] == 2 && $data['pos'] && $data['paid_amount'] > 0)) {
    ...
    public function genInvoice($id)
    {
        ...
        $card_number = '**** **** **** ' . substr($lims_sale_data->sale_note, -4);
        return view('sale.invoice', compact('card_number', 'lims_sale_data', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords'));
    }
