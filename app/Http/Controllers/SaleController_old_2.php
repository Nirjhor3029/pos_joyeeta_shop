...
/*        return dd($data->product_id);*/
        ...
        $product_qty_shop = $request->subtotal;
        ...
        for ($i = 0; $i < count($product_id_shop); $i++) {
            DB::table('shop_sales')->insert([
                ...
                'paid_amount' => $product_qty_shop[$i],
            ]);
        }
...
//                    }
    ...
    public function posSale()
    {
        ...
        if($role->hasPermissionTo('sales-add')){
            ...
            return view('sale.pos', compact('all_permission', 'lims_customer_list',
                'lims_customer_group_all', 'lims_warehouse_list', 'lims_product_list', 'product_number',
                'lims_tax_list', 'lims_biller_list', 'lims_pos_setting_data', 'lims_brand_list',
    ...
    public function genInvoice($id)
    {
        ...
        return view('sale.invoice', compact('shop_name','card_number','lims_sale_data', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords'));
    }
