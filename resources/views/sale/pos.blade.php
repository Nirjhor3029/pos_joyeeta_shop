...
?>
            ...
            <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required id="warehouse_id" name="warehouse_id"
                                                    class="bangla-font selectpicker form-control" data-live-search="true"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <span
                                                            class="totals-title">{{ trans('file.Subtotal') }}</span><span
                                                    ...
                                                    <div class="col-12">
                                                        <span
                                                            class="totals-title">{{ trans('file.Total') }}</span><span
                                                            id="total">0.00</span>
                                                    </div>
                                                    <div class="col-12">
                                                        <span class="totals-title">
                                                            + {{ trans('file.VAT') }} ({{ $general_setting->vat }}%)
                                                        </span>
                                            ...
                                            <div class="col-sm-6">
                                                <span class="totals-title">{{ 'Card Charge' }} <button type="button"
                                                        class="btn btn-link btn-sm" data-toggle="modal"
                                                        data-target="#order-tax"><i
                                                            class="dripicons-document-edit"></i></button></span><span
                                                    id="tax">0.00</span>
                                            </div>
                                            <!-- <div class="col-sm-4">                                                                                                                                                                                               <span class="totals-title">{{ trans('file.Shipping') }} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span><span id="shipping-cost">0.00</span>
                                                                                                                                                                                                                                                            </div> -->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="column-5">
                                <button style="background: #00cec9" type="button" class="btn btn-custom payment-btn"
                                    data-toggle="modal" data-target="#add-payment" id="cash-btn"><i
                                        class="fa fa-money"></i> Proceed</button>
                            </div>
                            <div class="column-5">
                    ...
                    <div role="document" class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 id="exampleModalLabel" class="modal-title">{{ trans('file.Finalize Sale') }}
                                </h5>
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-1">
                                                ...
                                                <textarea id="staff_note" rows="2" class="form-control"
                                                    name="staff_note"></textarea>
                                                <input type="hidden" name="change" class="form-control numkey" step="any">
                                                <input type="hidden" name="payment_note" id="payment_note" rows="2"
                                                    class="form-control" name="payment_note">
                                            ...
                                            <div class="col-md-6 mt-1">
                                                ...
                                                <input type="hidden" class="form-control" name="paid_by_id" value="1">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" name="order_discount" class="form-control numkey"
                                        placeholder="Percentage on total amount">
                                </div>
                ...
                <div id="order-tax" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                    ...
                    <div role="document" class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">{{ trans('file.Card charge') }}</h5>
                                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                        aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="order_tax_rate_select">
                                        <option value="0">No Card Charge</option>
                                                    ...
                                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications"
                                                        ...
                                                        <li class="notifications">
                                                            <a href="{{ route('report.qtyAlert') }}"
                                                                class="btn btn-link">{{ $alert_product }} product
                    ...
                    <div role="document" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="address" value="Dhaka" required class="form-control">
                                <input type="hidden" value="customer@joyeeta.com" name="email"
                                    placeholder="example@example.com" class="form-control">
                                <input type="hidden" name="city" value="Dhaka" required class="form-control" readonly>
    ...
    <script type="text/javascript">
        ...
        var VAT = {{ json_encode($general_setting->vat) }};
        var valid;
        ...
        function calculateTotal() {
            ...
            $('input[name="sub_total_price"]').val(subtotal.toFixed(2));

            let tmp_subtotal = subtotal;
            let totalVat = (VAT / 100) * tmp_subtotal;
            let totalPrice = tmp_subtotal + totalVat;

            $('input[name="total_vat"]').val(totalVat.toFixed(2));
        ...
        function calculateGrandTotal() {
            ...
            var subtotal = parseFloat($('input[name="sub_total_price"]').val());
            var vat = parseFloat($('input[name="total_vat"]').val());
            ...
            /*discount changed to percentage by salman starts*/
            // var order_discount = (order_discount * total) / 100;
            /*discount changed to percentage by salman end*/

            item = ++item + '(' + total_qty + ')';
            order_tax = (total - order_discount) * (order_tax / 100);
            // var grand_total = (total + order_tax + shipping_cost) - order_discount;
            // $('input[name="grand_total"]').val(grand_total.toFixed(2));

            // Edited : 28 feb 2022: discount only calculate on subtotal .. VAT excluded
            var total = (subtotal + order_tax + shipping_cost) - order_discount;
