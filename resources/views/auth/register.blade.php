                ...
                <div class="form-inner">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group-material">
                            ...
                            <label for="register-username" class="label-material">{{ trans('file.UserName') }}
                                *</label>
                            @if ($errors->has('name'))
                                <p>
                        ...
                        <div class="form-group-material">
                            <select name="role_id" required class="selectpicker form-control" data-live-search="true"
                        ...
                        <div class="form-group-material" id="biller-id">
                            <select name="biller_id" required class="selectpicker form-control" data-live-search="true"
