<title>{{substr($warehouse_name,0,4).' Sales report - '}}</title>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                ...
                <br>
                <h3 class="bangla-font text-center">{{$warehouse_name}}</h3>
            </div>
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group row">
                        ...
                        <div class="d-tc">
                            ...
                            <select id="warehouse_id" name="warehouse_id" class="bangla-font selectpicker form-control" data-live-search="true" data-live-search-style="begins">
