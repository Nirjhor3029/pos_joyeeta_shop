                            ...
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input id="cost_value" type="number" name="cost" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="price_value" type="number" name="price" required class="form-control" disabled step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    var CHARGE = {!! json_encode($general_settings->service_charge) !!};
    ...
    $(document).ready(function () {
        $("#cost_value").keyup( function () {
            ...
            let percentage = 0;
            cost_value = $(this).val();
            percentage = (cost_value)* (CHARGE/100);
            percentage = Math.round(parseFloat(percentage));
            price_value = parseInt(cost_value) +  percentage;
