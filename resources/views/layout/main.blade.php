...
@endif
                  <li id="holiday-menu"><a href="{{ route('holidays.index') }}">{{ trans('file.Holiday') }}</a></li>
                        ...
                        <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="report" class="collapse list-unstyled ">
                                ...
                                <li id="purchase-report-menu">
                                    ...
                                    <input type="hidden" name="warehouse_id" value="0" />
                                    <a id="purchase-report-link" href="">{{ trans('All Sell') }}</a>
                                    {!! Form::close() !!}
                                </li>
                    ...
                    @endif
                    <li><a href="#disbursement" aria-expanded="false" data-toggle="collapse"> <i
                                class="dripicons-gear"></i><span>Disbursement</span></a>
                        <ul id="disbursement" class="collapse list-unstyled ">
                            @if ($role->id <= 2)
                                <li id="disburse-report-menu"><a id="disburse-report-link"
                                        href="{{ route('disbursement.set') }}">SET</a></li>
                                <li id="disburse-report-menu"><a href="{{ route('disbursement.batchList') }}">Batch
                                        List</a></li>
                                <li id="disburse-report-menu"><a href="{{ route('disbursement.history') }}">Disburse
                                        History</a></li>
                            @endif
                        </ul>
                    </li>
                    <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
                        ...
                        <ul id="setting" class="collapse list-unstyled ">
                            ...
                            {{-- Edit: 26 feb --}}
                            @if ($general_setting_permission_active)
                                <li id="charges-setting-menu"><a href="{{ route('setting.extraCharge') }}">Charges
                                        settings</a>
                                </li>
                            @endif
    ...
    <div class="page">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="warehouse_id" class="bangla-font selectpicker form-control" required
                                    data-live-search="true" data-live-search-style="begins" title="Select Shop...">
        ...
        <div id="account-statement-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{ trans('file.Account Statement') }}
                        </h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
        ...
        <!-- disburse modal -->
        <div id="disburse-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
            class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <p>&copy; {{ $general_setting->site_title }} | {{ trans('file.Developed') }}
                            {{ trans('file.By') }} <a href="https://lion-coders.com"
                                class="external">ekShop</a></p>
                    </div>
                </div>
            </div>
        </footer>
