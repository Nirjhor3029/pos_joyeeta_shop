...
<!--               @if($index_permission_active)
              ...
              @endif
                <li><a href="#disbursement" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>Disbursement</span></a>
                    <ul id="disbursement" class="collapse list-unstyled ">
                        @if($role->id <= 2)
                            <li id="disburse-report-menu"><a id="disburse-report-link" href="{{route('disbursement.set')}}">SET</a></li>
                            <li id="disburse-report-menu"><a href="{{route('disbursement.batchList')}}">Batch List</a></li>
                            <li id="disburse-report-menu"><a href="{{route('disbursement.history')}}">Disburse History</a></li>
                        @endif
                    </ul>
                </li>
    ...
    <div class="page">
                    ...
                    ?>
                      <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="warehouse_id" class="bangla-font selectpicker form-control" required data-live-search="true" data-live-search-style="begins" title="Select Shop...">
      ...
      <div id="warehouse-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                ...
                <div class="modal-body">
                  <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                    ...
                    ?>
                      <div class="form-group">
                          <label>{{trans('file.Warehouse')}} *</label>
                          <select name="warehouse_id" class="bangla-font selectpicker form-control" required data-live-search="true" id="warehouse-id" data-live-search-style="begins" title="Select shop...">
                              @foreach($lims_warehouse_list as $warehouse)
                              <option value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                              @endforeach
                          </select>
        ...
        <!-- disburse modal -->
        <div id="disburse-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{trans('file.Warehouse Report')}}</h5>
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <a href="https://lion-coders.com" class="external">ekShop</a></p>
            </div>
          </div>
        </div>
      </footer>
    ...
    <script type="text/javascript">
      ...
      $("a#disburse-report-link").click(function(e){
          e.preventDefault();
          $('#disburse-modal').modal();
      });
